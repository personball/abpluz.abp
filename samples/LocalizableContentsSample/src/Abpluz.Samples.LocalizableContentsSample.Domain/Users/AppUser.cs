...
namespace Abpluz.Samples.LocalizableContentsSample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update LocalizableContentsSampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update LocalizableContentsSampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
