...
namespace Abpluz.Samples.SwitchableIdentityClientsSample.EntityFrameworkCore.Samples
{
    ...
    public class SampleRepositoryTests : SwitchableIdentityClientsSampleEntityFrameworkCoreTestBase
    {
