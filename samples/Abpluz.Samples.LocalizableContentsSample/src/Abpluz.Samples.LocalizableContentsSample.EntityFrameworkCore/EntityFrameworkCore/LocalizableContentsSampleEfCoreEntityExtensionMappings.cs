...
{
    public static class LocalizableContentsSampleEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE LocalizableContentsSampleModuleExtensionConfigurator CLASS (in the Domain.Shared project)
