...
namespace Pluz.Sample.Migrations
{
    ...
    [Migration("20200926083519_AddDemoProducts")]
    partial class AddDemoProducts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pluz.Sample.DemoProducts.DemoProduct", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Pluz.Sample.DemoProducts.DemoProductLocalizableEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("Id", "CultureName");

                    b.ToTable("DemoProductLocalizableEntries");
                });
            ...
            modelBuilder.Entity("Pluz.Sample.DemoProducts.DemoProductLocalizableEntry", b =>
                {
                    b.HasOne("Pluz.Sample.DemoProducts.DemoProduct", null)
                        .WithMany("Entries")
                        .HasForeignKey("Id")
