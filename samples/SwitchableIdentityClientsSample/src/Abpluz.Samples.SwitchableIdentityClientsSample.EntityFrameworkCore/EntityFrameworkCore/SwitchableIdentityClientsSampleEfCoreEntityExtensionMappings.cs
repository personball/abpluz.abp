...
{
    public static class SwitchableIdentityClientsSampleEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE SwitchableIdentityClientsSampleModuleExtensionConfigurator CLASS (in the Domain.Shared project)
