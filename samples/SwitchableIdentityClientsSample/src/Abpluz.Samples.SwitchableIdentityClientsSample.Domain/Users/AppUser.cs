...
namespace Abpluz.Samples.SwitchableIdentityClientsSample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update SwitchableIdentityClientsSampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update SwitchableIdentityClientsSampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
